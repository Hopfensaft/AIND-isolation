...
class MinimaxPlayer(IsolationPlayer):
    ...
    def min_value(self, game, depth, search_depth):
        ...
        for m in game.get_legal_moves():
            v = min(v, self.max_value(game.forecast_move(m), depth + 1, search_depth))
        return v

    def max_value(self, game, depth, search_depth):
        ...
        if depth >= search_depth:
            return self.score(game, self)
        for m in game.get_legal_moves():
            v = max(v, self.min_value(game.forecast_move(m), depth + 1, search_depth))
        return v
    ...
    def minimax(self, game, search_depth):
        ...
        **********************************************************************
        ...
        for move in game.get_legal_moves():
            value = self.min_value(game.forecast_move(move), depth + 1, search_depth)
            if top_score < value:
                top_score = value
                top_move = move
        return top_move
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def min_value(self, game, depth, search_depth, alpha, beta):
        """ Return the value for a win (+1) if the game is over,
        otherwise return the minimum value over all legal child
        nodes.
        """
        ...
        if depth >= search_depth:
            return self.score(game, self)
        for m in game.get_legal_moves():
            v = min(v, self.max_value(game.forecast_move(m), depth + 1, search_depth, alpha, beta))
            if v <= alpha:
                return v
            beta = min(v, beta)
        return v

    def max_value(self, game, depth, search_depth, alpha, beta):
        """ Return the value for a loss (-1) if the game is over,
        otherwise return the maximum value over all legal child
        nodes.
        """
        ...
        if depth >= search_depth:
            return self.score(game, self)
        for m in game.get_legal_moves():
            v = max(v, self.min_value(game.forecast_move(m), depth + 1, search_depth, alpha, beta))
            if v >= beta:
                return v
            alpha = max(v, alpha)
        return v
    ...
    def alphabeta(self, game, search_depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        for move in game.get_legal_moves():
            value = self.min_value(game.forecast_move(move), depth + 1, search_depth, alpha, beta)
            if top_score < value:
                top_score = value
                top_move = move
                alpha = top_score
